	...
	public class Main extends JFrame {
	    ...
	    public Double calculate1(Double x, Double y, Double z) {
	        ...
	        this.mem2 = y;
	        this.mem3 = z;
	        return ((Math.pow((Math.log(1 + x) + Math.cos(Math.PI * Math.pow(z, 3))), Math.sin(y))) +
	                (Math.pow(Math.exp(Math.pow(x, 2)) + Math.cos(Math.exp(z)) + Math.sqrt(1 / y), y / x)));
	    }
	    ...
	    public Double calculate2(Double x, Double y, Double z) {
	        ...
	        this.mem2 = y;
	        this.mem3 = z;
	        return y * ((Math.pow(x, 2) / (Math.log10(Math.pow(z, y)) + Math.pow(Math.cos(3 * Math.sqrt(x)), 2))));
	    }
